...
export default class CourseComparison extends React.Component {
  ...
  move = () => {
    var CourseOne = this.state.CourseList.filter(x => x.CourseName == this.state.selectCourse)
    this.props.navigation.navigate('CourseComparison2', {
      Course1: CourseOne
    })
  }
      ...
      <ScrollView style={styles.container}>
        ...
        <View>
          <View style={{ height: 200 }}>
            <Text style={{ fontWeight: 'bold', fontSize: 16, textAlign: 'left', marginHorizontal: 20, marginTop: 10 }}>Program 1:</Text>
            <Picker
          ...
          {this.state.selectProgram == '' ?
            ...
            :
            <View style={{ height: 200 }}>
              <Text style={{ fontWeight: 'bold', fontSize: 16, textAlign: 'left', marginHorizontal: 20, marginTop: 10 }}>Faculties 1:</Text>
              <Picker
          ...
          {this.state.selectFaculty == '' ?
            ...
            :
            <View style={{ height: 200 }}>
              <Text style={{ fontWeight: 'bold', fontSize: 16, textAlign: 'left', marginHorizontal: 20, marginTop: 20 }}>School 1:</Text>
              <Picker
          ...
          {this.state.selectCourse == '' ?
            ...
            <TouchableOpacity style={{ height: 50, width: '70%', borderRadius: 50, backgroundColor: 'grey', justifyContent: 'center', alignItems: 'center', alignSelf: 'center', marginVertical: 70 }}
              onPress={() => this.move()} >
              <Text>Choose second course </Text>
            </TouchableOpacity>
          }
